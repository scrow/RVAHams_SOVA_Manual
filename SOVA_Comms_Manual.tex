...
Equipment will be color coded for ease of installation. The following frequencies will be color coded as follows:

\begin{tabular}{ccc}
Frequency & Use & Color \\
442.550 MHz & Net Control & RED \\
151.940 MHz & Logistics & YELLOW \\
456.800 MHz & Security & BLUE \\
469.500 MHz  & Medical & BLUE \\
\end{tabular}

Each Control station will be setup with antenna’s installed and ready for deployment, a 12 volt 25 or 30 amp switching power supply connected to an Anderson Power Pole expansion board and then connected to each radio. Each radio is connected via a CAT5 cable to a push button selector switch, which is then connected to a single desktop or handheld microphone.

% *** Add the Net Control Box Layout under this information ***
