...
\section{Operations Organization}

The Radio Communications Committee is comprised of the following personnel: 

\paragraph{Communications Director(s)} are responsible for the upkeep and maintenance of the HamSoVa.net website, obtaining loaned amateur radio equipment per the radio communications design plan, promoting and recruiting Amateur Radio Operators, completion of the final personnel plan and ensure a smooth operation of the plans set forth in this document.  

\paragraph{Radio Communications Commissioner} is responsible for coordination and distribution of all radios and other communications equipment required to execute the mission of the Virginia Special Olympics Summer Games.  

\paragraph{Net Control Operators} are responsible for monitoring the radio traffic and maintaining contact with the Amateur Radio Operators, Logistics and Security personnel in the field.  Net Control Operators are required to effectively handle radio communications with both Security and the Virginia Special Olympics Logistics Team.  Respectively they will also handle Emergency communications between Amateur Radio operators and Logistics or Security.

\paragraph{Logistics Net Control} is responsible for maintaining radio communication to and from the Amateur Radio Operators assigned to the various venue/coordinator of an event. 
...
Each Control station will be setup with antennas installed and ready for deployment, a 12 volt 25 or 30 amp switching power supply connected to an Anderson Power Pole expansion board and then connected to each radio. Each radio is connected via a CAT5 cable to a push button selector switch, which is then connected to a single desktop or handheld microphone.
